...
import { northLasVegasCommunities, getNorthLasVegasCommunity } from '@/lib/north-las-vegas-communities'
...
export async function generateStaticParams() {
  return northLasVegasCommunities.map((c) => ({ slug: c.slug }))
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://nevadarealestatemarket.com/north-las-vegas/${slug}` },
  }
}
...
export default async function NorthLasVegasCommunityPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    name: 'Dr. Jan Duffy',
    url: `https://nevadarealestatemarket.com/north-las-vegas/${slug}`,
    telephone: '702-222-1964',
    address: {
      '@type': 'PostalAddress',
      streetAddress: '2290 Beauty Vista Ave',
      ...
      <main>
        <section className="bg-blue-950 text-white py-16 px-4">
          <div className="max-w-5xl mx-auto">
            <p className="text-yellow-400 text-sm font-semibold mb-2">
              North Las Vegas, NV Communities
            </p>
        ...
        <section className="border-t py-8 px-4">
          <div className="max-w-5xl mx-auto flex items-center justify-between">
            <a href="/north-las-vegas" className="text-blue-700 hover:underline font-medium">
              ← All North Las Vegas Communities
            </a>
