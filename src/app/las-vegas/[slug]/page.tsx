...
import { lasVegasCommunities, getLasVegasCommunity } from '@/lib/las-vegas-communities'
...
export async function generateStaticParams() {
  return lasVegasCommunities.map((c) => ({ slug: c.slug }))
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://nevadarealestatemarket.com/las-vegas/${slug}` },
  }
}
...
export default async function LasVegasCommunityPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    name: 'Dr. Jan Duffy',
    url: `https://nevadarealestatemarket.com/las-vegas/${slug}`,
    telephone: '702-222-1964',
    address: {
      '@type': 'PostalAddress',
      streetAddress: '8850 W. Sunset Rd, Suite 200',
      ...
      <main>
            ...
            <aside>
              <div className="bg-blue-950 text-white rounded-xl p-6 sticky top-24">
                ...
                <p className="text-blue-200 text-sm mb-6">
                  I track every sale in this neighborhood. Let me pull fresh comps
        ...
        <section className="border-t py-8 px-4">
          <div className="max-w-5xl mx-auto flex items-center justify-between">
            <a href="/las-vegas" className="text-blue-700 hover:underline font-medium">
